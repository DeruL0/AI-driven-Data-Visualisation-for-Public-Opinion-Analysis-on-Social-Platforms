...
# Word2Vec_path = 'embed32_batchsize516_without_dropout/word2vec_embed32_epoch30.model'
embedding_dim = 32
...
def process_raw_data():
    ...
    model = Word2Vec.load('/models/word2vec_embed32_epoch30.model')
    ...
    # file = open('embed32_batchsize516_without_dropout\proccess_embed32_epoch30.pkl','rb')
...
@torch.no_grad()
def sentiment_predict(output_path='result_test.txt'):
    r"""
    ...
    model.load_state_dict(
        torch.load('/models/transformer_train.model',
                   map_location=device))
    model.to(device)
    y_pred = []
    num_zero = 0
